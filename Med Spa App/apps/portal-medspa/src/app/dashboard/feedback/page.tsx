  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-600 dark:text-slate-400">Submit bugs, feature requests, and improvements.</p>
      </div>
      ...
      {feedback.length === 0 && !error ? (
        <div className="rounded-lg border border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-950 p-12 text-center">
          <p className="text-sm text-gray-500 dark:text-slate-400">No feedback yet.</p>
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="rounded-md bg-gray-100 dark:bg-slate-800 px-2 py-0.5 text-xs font-medium capitalize text-gray-700 dark:text-slate-300">
                    {item.category}
                  </span>
                  ...
                  <span className="rounded-md bg-blue-50 dark:bg-blue-900/30 px-2 py-0.5 text-xs font-medium capitalize text-blue-700 dark:text-blue-300">
                    {item.status}
                  </span>
                </div>
              ...
              <p className="mt-2 text-sm text-gray-700 dark:text-slate-300">{item.message}</p>
            </div>
          ))}
        </div>
      )}
